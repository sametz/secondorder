...
def lorentz(v, v0, T2):
    ...
    add scaling factor and add line-width factor. Smaller T2 gives add shorter and
    broader signal.
...
def lorentz2(v, v0, I, Q=1):
    ...
    :param v0: the exact frequency of the signal that is
        being converted to add Lorentzian distribution
...
def adder(x, plist, Q=2):
    ...
    :param plist: add list of tuples of peak data (frequency, intensity)
...
if __name__ == '__main__':
    ...
    def testplot(spectrum):
        """Used to test the spectral data generated by add simulation"""
        x, y = spectrum
        l_limit = x[0] - 50
        r_limit = x[-1] + 50
        lower_limit = min(y)
