...
from secondorder.nmrplot import tkplot, dnmrplot_2spin, dnmrplot_AB
...
# tools
from secondorder.nmrmath import AB, AB2, ABX, ABX3, AAXX, first_order, \
    AABB
from secondorder.nmrmath import nspinspec
...
class ModelFrames(GuiMixin, Frame):
    ...
    CalcTypeFrame.
    """
    def __init__(self, parent=None, BarFrame=None, **options):
        Frame.__init__(self, parent, **options)
    ...
    def add_multiplet_buttons(self):
        ...
        self.ab = AB_Bar(self.BarFrame)
        self.ab2 = AB2_Bar(self.BarFrame)
        self.abx = ABX_Bar(self.BarFrame)
        self.abx3 = ABX3_Bar(self.BarFrame)
        self.aaxx = AAXX_Bar(self.BarFrame)
        self.firstorder = FirstOrder_Bar(self.BarFrame)
        self.aabb = AABB_Bar(self.BarFrame)
    ...
    def add_abc_buttons(self):
        ...
        self.ABC_Buttons = RadioFrame(self,
                                      buttons=abc_buttons,
                                      title='2-7 Spins')
        self.spin3 = nSpinBar(self.BarFrame, n=3)
        self.spin4 = nSpinBar(self.BarFrame, n=4)
        self.spin5 = nSpinBar(self.BarFrame, n=5)
        self.spin6 = nSpinBar(self.BarFrame, n=6)
        self.spin7 = nSpinBar(self.BarFrame, n=7)
        self.spin8 = nSpinBar(self.BarFrame, n=8)
    ...
    def add_dnmr_buttons(self):
        ...
        self.DNMR_Buttons = RadioFrame(self,
                                       ...
                                       title='DNMR')
        self.TwoSpinBar = DNMR_TwoSingletBar(self.BarFrame)
        self.DNMR_AB_Bar = DNMR_AB_Bar(self.BarFrame)
...
class View(Frame):
    def __init__(self, parent=None, **options):
        ...
        f = Figure(figsize=(5, 4), dpi=100)
        self.canvas = MPLgraph(f, self)

        # Create sidebar widgets:
        CalcTypeFrame(self.SideFrame, relief=SUNKEN, borderwidth=1).pack(side=TOP,
                                                                    expand=NO,
                                                                    fill=X)
        self.Models = ModelFrames(self.SideFrame,
                                  BarFrame=self.TopFrame,
                                  relief=SUNKEN,
                                  borderwidth=1)
        ...
        self.clickyFrame = Frame(self.SideFrame, relief=SUNKEN, borderwidth=1)
        self.clickyFrame.pack(side=TOP, expand=YES, fill=X)
        Label(self.clickyFrame, text='clickys go here').pack()
